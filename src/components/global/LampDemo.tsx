  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="w-full mt-20 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0 -mt-[203px]',
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-neutral-950 bg-opacity-50 blur-2xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-neutral-400 bg-opacity-50 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: '15rem' }}
