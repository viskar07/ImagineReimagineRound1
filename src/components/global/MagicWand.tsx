  ...
  'rounded-l-[8px] bg-bg-wand relative',
  {
    variants: {
      variant: {
        ...
        horizontal: 'z-30 w-[200px] h-[46px] md:w-[520px] md:h-[56px] mt-10 '
      },
      glow: {
        light: ''
      }
...
const MagicWand = ({ className, variant }: wandProps) => {
  ...
  return (
    <div className={cn(magicWandVarients({ variant }))}    >
      ...
      <div className="wand-streak absolute w-[380px] md:w-[430px] h-1 top-[50%] bottom-[50%] -translate-y-1/2 z-40" ></div>
