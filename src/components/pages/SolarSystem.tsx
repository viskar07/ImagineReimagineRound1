import { Dcutout, orbit1, orbit2, orbit3, orbit4, orbit5, orbit6, orbit7, orbit8, planet1, planet2, planet3, planet4, planet5, planet6, planet7, planet8 } from '@/lib/constants'
    ...
    <div className='w-full h-full mt-10 z-10'>
      <div className="w-full h-screen flex flex-col justify-center items-center overflow-visible relative">
        ...
        <div className="w-[152px] h-[152px] rounded-full bg-[#656566] relative">
          <div className='absolute w-[152px] h-[152px] rounded-full bg-white bottom-2 ' >
            <Image src={Dcutout} width={54} height={94} alt='D-cutout' className='absolute top-[20px] left-[78px]' />
